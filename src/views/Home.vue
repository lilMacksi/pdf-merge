<template>
  <div class="container margin-top-2">
    <EmptyState v-if="!this.mergedFileBytes" @merge="onFileChange"/>
      ...
      <div class="col-xs-12 col-md-6">
        <div class="row" v-if="this.mergedFileBytes">
          ...
          <div class="col-xs-12 margin-bottom-2">
            <sdx-button-group layout="fill" v-if="this.mergedFileBytes">
          ...
          <div class="col-xs-12 row">
            <sdx-input-item type="checkbox" class="col-xs-12" :checked="customName" :change-callback.prop="onCustomNameChange">
          ...
          <draggable v-model="fileArray" class="row col-xs-12 bg-sc-navy margin-1" draggable=".item" @change="draggableChanged" @start="drag=true" @end="drag=false">
            <div v-for="(el, i) in fileArray" class="item col-xs-12 col-md-6 padding-3" :key="el.name">
              <p class="text-truncate text-smaller white"> {{i+1}}. {{el.name}}</p>
              <pdf
